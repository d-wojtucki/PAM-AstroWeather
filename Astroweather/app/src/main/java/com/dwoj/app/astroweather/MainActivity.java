...
public class MainActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(findViewById(R.id.layout_large_land) == null) {
    ...
    public void setTime() {
        ...
        if (DateFormat.is24HourFormat(this)) {
            ...
            mClockView.setText(hours + ":" + (minutes < 10 ? "0" + minutes : minutes) + ":" + (seconds < 10 ? "0" + seconds : seconds) + " " + new DateFormatSymbols().getAmPmStrings()[cal.get(Calendar.AM_PM)]);
        }
    }
    ...
    private class MyPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int pos) {
            switch(pos) {
                ...
                case 0: return FirstFragment.newInstance("Sun Info");
                case 1: return SecondFragment.newInstance("Moon Info");
    ...
    public static AstroCalculator getAstroCalculator(){
        ...
        AstroDateTime astroDateTime = new AstroDateTime(calendar.get(calendar.YEAR),
                ...
                calendar.get(calendar.DAY_OF_MONTH), calendar.get(calendar.ZONE_OFFSET) / (3600 * 1000), calendar.get(calendar.DST_OFFSET) > 0);
